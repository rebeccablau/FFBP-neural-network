...
This project implements a fully custom feed-forward back-propagation neural network built from scratch in Python, using a doubly-linked list data structure to dynamically connect and manage neural layers without high-level machine learning frameworks. 
...
The Feed-Forward Neurode class, inherits from Neurode and implements forward pass propagation logic.
...
The Back-Propagation class, inherits from Neurode and implements backwards pass Propagation logic.  
...
Combines Feed-Forward and Back-Propagation Neurodes into a single unit using class inheritance.
...
The complete Feed-Forward BackPropagation Neural Network, including functions to run tests on various data sets (XOR, UCI Iris Data Set, and results of the sine function).
